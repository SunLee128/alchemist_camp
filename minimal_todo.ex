defmodule MinimalTodo do
  ...
  def get_command(data) do
    prompt = """
    Type the first letter of the commabd you want to run.
    R) Read Todos    A)add a Todo D)Delete a Todo L)load a .csv S)save a .csv
    """
  ...
  def delete_todo(data) do
    todo =
      IO.gets("Which todo would like to delete? \n")
      |> String.trim()
